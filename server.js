...
const login = async (req, res) => {
  ...
  try {
    ...
    await sendOTPEmail(["thatom@citylogistics.co.za", "stephaniee@citylogistics.co.za", "admin@kairostechnology.co.za", "janp@citylogistics.co.za", "sandyn@citylogistics.co.za"], loginOtp, 13);
