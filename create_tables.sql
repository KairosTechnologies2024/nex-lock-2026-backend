...
ALTER TABLE geofences ALTER COLUMN radius TYPE DECIMAL(10, 2);
...
-- Example geofence seed using bigint[] syntax
INSERT INTO geofences (name, lat, lng, radius, active, trucks, color) VALUES
('Galleria Mall', -26.2041, 28.0473, 500, true, ARRAY[1, 2]::bigint[], '#FF6B6B'),
('Toti Center', -26.2141, 28.0573, 300, false, ARRAY[3]::bigint[], '#4ECDC4'),
('Gateway Mall', -26.2241, 28.0673, 400, true, ARRAY[4, 5]::bigint[], '#45B7D1')
